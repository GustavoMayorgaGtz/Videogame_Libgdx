 ...
 public class Nivel7 implements Screen {
    ...
    boolean Empezar;
     ...
     public Nivel7(MyGdxGame game) {

         this.game = game;
         mapLoader = new TmxMapLoader();
         map = mapLoader.load("Nivel(6).tmx");
         mapLoader2 = new TmxMapLoader();
         map2 = mapLoader2.load("Nivel(6)Fondo.tmx");
         ///////////////////////////////////////////////////////////////////////////////////////////////
 ...
 Gdx.input.setCatchBackKey(true);
     ...
     public void render(float delta) {
        // time += Gdx.graphics.getDeltaTime();
         ...
         batch.draw(fondoAnimado,(addR.cam.position.x-100)+x,addR.cam.position.y-50,Gdx.graphics.getWidth()+150,Gdx.graphics.getHeight()+50);
         batch.end();
         update(delta);
        renderer2.render();
