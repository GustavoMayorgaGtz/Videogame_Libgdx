...
public abstract class InteractiveTileCameraNOY extends Actor implements Disposable {
    ...
    public InteractiveTileCameraNOY(World world, TiledMap map, Rectangle bounds, int iterator)    {
        this.world = world;
        this.map = map;
        this.bounds = bounds;
        ...
        r.rectangulosNoY.add(iterator,new Rectangle(getX(),getY(),getWidth(),getHeight()));
            }
