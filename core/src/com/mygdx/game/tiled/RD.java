...
public class RD extends InteractiveTileObject{
    //Sierra s;
    public RD(World world, TiledMap map, Rectangle bounds) {
    ...
    public void Sierra() {
        switch(WorldContactListener.name)
        {
            case 0:
            {
                AddActors.s1.setRD(true);
                break;
            }
            case 1:
            {
                AddActors.s2.setRD(true);
                break;
            }
            case 2:
            {
                AddActors.s3.setRD(true);
                break;
            }
            case 3:
            {
                AddActors.s4.setRD(true);
                break;
            }

            case 4:
            {
                AddActors.s5.setRD(true);
                break;
            }
        }
