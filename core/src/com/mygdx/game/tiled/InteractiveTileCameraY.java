...
public abstract class InteractiveTileCameraY extends Actor implements Disposable {
    ...
    public InteractiveTileCameraY(World world, TiledMap map, Rectangle bounds,int iterator)    {
        this.world = world;
        this.map = map;
        this.bounds = bounds;
        ...
        r.rectangulosY.add(iterator,new Rectangle(getX(),getY(),getWidth(),getHeight()));
            }
