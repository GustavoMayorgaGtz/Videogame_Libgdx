...
public abstract class InteractiveTileCameraX extends Actor implements Disposable {
    ...
    public InteractiveTileCameraX(World world, TiledMap map, Rectangle bounds, int iterator)    {
        this.world = world;
        this.map = map;
        this.bounds = bounds;
        ...
        r.rectangulosX.add(iterator,new Rectangle(getX(),getY(),getWidth(),getHeight()));
            }
